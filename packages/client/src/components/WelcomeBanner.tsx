    ...
    <div className="bg-orange-700 text-white">
      <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
        <div className="flex-1">
          ...
          <p className="text-orange-200 text-sm mt-0.5">{t("welcome.subtitle")}</p>
        </div>
        <div className="flex gap-3 items-center flex-shrink-0">
          <Link
            to="/catalog"
            onClick={handleDismiss}
            className="px-3 py-1.5 bg-white text-orange-600 rounded text-sm font-medium hover:bg-orange-50"
          >
