...
import type { Review, CreateReviewInput, UpdateReviewInput, ReviewStats, ApiResponse } from '@ting/shared';
...
router.get('/item/:itemId/stats', resolveOrganizationPublic, async (req: AuthRequest, res: Response) => {
  try {
    const { itemId } = req.params;
